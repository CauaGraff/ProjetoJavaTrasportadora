...
public class ControllerTelaMotorista implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		motoristaDao = new MotoristaDao(); popularTabelaMotorista();
...
//			LocalDate localDate = datePickerNascimento.getValue();
...
//		localDate = motorista.getDataNasc();
//		datePickerNascimento.setValue(LocalDate.now(localDate));
